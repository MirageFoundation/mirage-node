...
**Previous review:** [`review-2026-05-09.md`](review-2026-05-09.md) (baseline `v1.24.4`).
...
If remediation lands in the same release cycle, produce `docs/security/blockchain/review-2026-08-04-retest.md` following the pattern in [`review-2026-03-12-retest.md`](review-2026-03-12-retest.md):
...
when an earlier scan fails. The release uses Go 1.25.12 and patched dependency
versions for gRPC, `x/net`, `x/text`, OpenTelemetry, and quic-go; this removed
all ten advisories that had an upstream fix. Both replacement modules scan
clean.
