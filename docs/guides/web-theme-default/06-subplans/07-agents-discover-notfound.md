...
**Files:** `themes/default/routes/{AgentsView,DiscoverView,NotFoundView}.js`
**Status:** ✅ Done
...
> Rewrites `default`'s Agents / Discover / NotFound routes with R1–R7 tokens and mobile-app visuals. Visual only. Closes sub-plan 06.7.
