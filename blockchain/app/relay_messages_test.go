...
func TestRelayMessageRegistryParity(t *testing.T) {
	...
	require.Equal(t, 39, len(prototypes), "update this count when adding/removing relay message types")
...
func TestRelayDecoratorSwitchParity(t *testing.T) {
	...
	require.Len(t, registry, 39, "update this count when adding/removing relay message types")
