...
func TestRelayMessageRegistryParity(t *testing.T) {
	...
	require.Equal(t, 43, len(prototypes), "update this count when adding/removing relay message types")
...
func TestRelayDecoratorSwitchParity(t *testing.T) {
	...
	require.Len(t, registry, 43, "update this count when adding/removing relay message types")
