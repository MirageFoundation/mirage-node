...
import (
	_ "mirage/x/core/module"
	coremoduletypes "mirage/x/core/types"
...
var (
	moduleAccPerms = []*authmodulev1.ModuleAccountPermission{
		...
		{Account: coremoduletypes.CreatorPoolName, Permissions: []string{authtypes.Burner}},
		// this line is used by starport scaffolding # stargate/app/maccPerms
	}

	// Block module accounts that should not receive direct transfers
	blockAccAddrs = []string{
		...
		coremoduletypes.CreatorPoolName,
	}
		...
		Modules: []*appv1alpha1.ModuleConfig{
			{
				...
				Config: appconfig.WrapAny(&runtimev1alpha1.Module{
					...
					EndBlockers: []string{
						// x/bank must run first in EndBlock as of SDK v0.54 (BlockSTM finalization step)
			...
			},
			{
				...
				Config: appconfig.WrapAny(&authmodulev1.Module{
					...
					// Authority: "gov", // A custom module authority can be set using a module name
