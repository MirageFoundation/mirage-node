...
func RegisterInterfaces(registry codectypes.InterfaceRegistry) {
	msgTypes := []sdk.Msg{
		...
		&MsgSetCurationTag{}, &MsgSetCurationPostTag{},
	...
	msgResponseTypes := []proto.Message{
		...
		&MsgSetCurationTagResponse{}, &MsgSetCurationPostTagResponse{},
...
func RetiredMsgTypeURLs() map[string]struct{} {
	return map[string]struct{}{
		...
		sdk.MsgTypeURL(&MsgCreateCommunity{}):        {},
		sdk.MsgTypeURL(&MsgSetCommunityMetadata{}):   {},
		sdk.MsgTypeURL(&MsgTransferCommunity{}):      {},
		sdk.MsgTypeURL(&MsgGovCreateCommunity{}):     {},
		sdk.MsgTypeURL(&MsgGovSetCommunityFounder{}): {},
	}
}
