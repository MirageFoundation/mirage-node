...
// and no validator currently runs it. The orchestrator-side signer paths in
// this file are not exercised in production. The code is retained to keep the
// package compilable and preserve the design while a bridge replacement is
// being scoped.
//
