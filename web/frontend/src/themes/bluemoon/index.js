...
import BlueMoonShell from './BlueMoonShell';
import BlueMoonFeedView from './BlueMoonFeedView';
import BlueMoonVoteSection from './components/VoteSection';
...
const bluemoonManifest = {
    ...
    Style,
    Shell: BlueMoonShell,
    Feed: BlueMoonFeedView,
    VoteSection: BlueMoonVoteSection,
    components,
    routes,
    config: {
        showHeroCards: true,
...
export default bluemoonManifest;
