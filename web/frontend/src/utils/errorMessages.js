...
const ERROR_MAP = {
    ...
    invalid_scope: "That feed scope isn't valid.",
    invalid_lens: "That feed lens isn't valid.",
    invalid_team_id: "That curator team id isn't valid.",
    team_lens_requires_team_and_community: "A team lens needs both a team and a community.",
    team_id_requires_team_lens: "A team id is only valid with the team lens.",
    legacy_scope_requires_raw_lens: "That older feed scope only works with the raw lens.",
    invalid_lens_picks: "Those lens picks aren't valid.",
    too_many_lens_picks: "Too many lens picks in that request.",
