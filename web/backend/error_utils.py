...
ERRORS = {
    ...
    "invalid_identity_challenge": "origin and nonce must be a valid identity challenge",
    "not_found": "not found",
    ...
    "community_too_short": "community too short",
    "community_too_long": "community too long",
    "community_invalid_format": "invalid community format",
    "community_too_many_wildcards": "too many wildcards in community pattern",
    "post_community_required": "community required for root posts",
    ...
    "community_already_blocked": "community is already blocked",
    "user_already_followed": "user is already followed",
    "community_already_joined": "community is already joined",
