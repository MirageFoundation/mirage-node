...
export MONIKER CHAIN_ID PERSISTENT_PEERS PEX_ENABLED MAX_INBOUND_PEERS MAX_OUTBOUND_PEERS RETENTION_BLOCKS PRUNING_INTERVAL SNAPSHOT_INTERVAL SNAPSHOT_KEEP_RECENT APP_DB_BACKEND COMET_DB_BACKEND STATESYNC_ENABLE STATESYNC_RPC_SERVERS STATESYNC_TRUST_HEIGHT STATESYNC_TRUST_HASH
